...
<template>
  <SmallScrollTextWindow>
    <p>合同会社 知的・自転車（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
    ...
    <ul>
      ...
      <li>個人情報を特定の者との間で共同して利用する場合であって，その旨並びに共同して利用される個人情報の項目，共同して利用する者の範囲，利用する者の利用目的および当該個人* 情報の管理について責任を有する者の氏名または名称について，あらかじめ本人に通知し，または本人が容易に知り得る状態に置いた場合</li>
    </ul>
    ...
    <ul>
      <li>社名：合同会社 知的・自転車</li>
      <li>担当：四方宏樹</li>
    </ul>
    <p>ご連絡は、<a href="/contact/">お問い合わせフォーム</a>からお願いいたします。</p>
  </SmallScrollTextWindow>
</template>